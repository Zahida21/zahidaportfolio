...
const Navbar = () => {
  ...
  // const toggleResume = () => {
  //   const resumeUrl = '/Fathimath-Zahida-Resume.pdf';
  ...
  const renderNavLinks = (isSecondary) => (
    ...
    <ul className={`list-none ${isSecondary ? 'flex sm:hidden flex-col gap-4 items-start' : 'hidden sm:flex flex-row gap-6'}`}>
    ...
    <>
      ...
      >
        <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
          ...
          >
            <img src={logo} alt="logo" className="w-9 h-9 object-cover border rounded-full" />
